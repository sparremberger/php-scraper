...
//$resposta = $browser->post("https://veiculos.fipe.org.br/api/veiculos//ConsultarTabelaDeReferencia", http_build_query($postData), 'application/x-www-form-urlencoded');
...
//$codMarca = var_dump($retornoMarcas[0]->Value);
